...
btn6.grid(row=2, column=0, padx=5)
...
btn11.grid(row=3, column=1, padx=5)
...
btn16.grid(row=4, column=1, padx=5)
...
btn21.grid(row=5, column=1, padx=5)
...
btn24=Button(root, text='=', width=4, height=2)
btn24.grid(row=5, column=4, padx=5, rowspan=2)
...
btn26.grid(row=6, column=2, padx=5)
